...
Dose rate effects during irradiation for the yellowing are well documented  ~\cite{sauli,34504,Wick1991472,289295,173180,173178,Giokaris1993315}.
The presence of oxygen plays an important role.  The studies show that the penetration depth of oxygen into the substrate
...
to reproduce the time dependence of the induced attenuation length in scintillators based on PS and PMMA~\cite{Wick1991472}.  
...
can occur even without oxygen, reducing the initial damage.
After irradiation, oxygen continues to play a role.
Oxygen
diffuses into the plastic, reduces the color center density, and the plastic ``bleaches''.  On time scales of the order of months, the bleaching stops, and some permanent damage (color centers) remains~\cite{sauli}.
The amount of permanent damage seems to be independant of the
dose rate \cite{sauli}.
Oxygen is essential for this curing process, although samples irradiated in inert atmospheres have smaller permanent damage, even if the initial damage for high dose rate exposures maybe larger~\cite{zorn2}.  
